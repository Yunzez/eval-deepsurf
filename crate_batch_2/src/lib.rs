use flif::Flif;
// use geo::{coord, ConvexHull, LineString}; // disabled: geo->spade requires nightly iter_repeat_n
use gif::DecodeOptions;
use goblin::archive::Index;
use handlebars::Handlebars;
use human_name::Name;
// use hyper::{Uri, Url}; // disabled: hyper pulls in url 2.5/icu requiring Rust >=1.82
...
pub fn benchmark_vec_u8(data: &[u8]) {
    unsafe {
        ...
        // --- run 3 disabled: geo -> spade requires nightly iter_repeat_n -------
        // {
...
pub fn benchmark_strings(str: &str, str2: &str) {
    unsafe {
        ...
        // --- run 8 ---------------------------------------------------------------
        {
        // Disabled: hyper::Url pulls in url 2.5/icu requiring Rust >=1.82.
